...
public class PoolExample {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 0; i < 30; i++) {
            ...
            while (executor.getActiveCount() == 3) // ждём пока освободится поток
            ...
            //executor.setRejectedExecutionHandler((runnable, x) -> System.out.println("Rejected")); тут можно добавлять в лист отменённые потоки, а потом снова их запускать
        }
